      ...
      screens: {
        ...
        TradieTabs: {
          screens: {
            ...
            Messages: '/tradie/messages',
            Chat: '/tradie/messages/chat',
            SubmitQuote: '/tradie/submit-quote',
            Wallet: '/tradie/wallet',
            Insights: '/tradie/insights',
            SuburbRankings: '/tradie/insights/rankings',
            SuburbDetail: '/tradie/insights/suburb',
            TradeOpportunity: '/tradie/insights/trades',
            Notifications: '/tradie/notifications',
            Settings: '/tradie/settings',
            Help: '/tradie/help',
